...
adjoint_forward: w2f__types.o OAD_active.o kees_model.pre.xb.x2w.w2f.post.o adj_fwd_model.o
	$(fort) $^ -o adj_fwd_model

# Compile the tangent linear model using reverse mode
adjoint_reverse: w2f__types.o $(reverse_obj) OAD_active.o kees_model.pre.xb.x2w.w2f.post.o adj_rev_model.o
	$(fort) $^ -o adj_rev_model
